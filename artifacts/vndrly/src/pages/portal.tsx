                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    {ticketDetail.afe && (
                      <div className="mt-1">
                        <span
                          className="inline-flex items-center text-[11px] font-bold text-white px-2.5 py-0.5 rounded-full border border-blue-700/60 shadow-sm bg-gradient-to-b from-sky-400 via-blue-500 to-blue-700"
                          data-testid="text-portal-tracking-afe"
                        >
