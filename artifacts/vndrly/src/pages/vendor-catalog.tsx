                              ...
                              >
                                {inlineAfes.map(({ afe, siteNames }) => {
                                  ...
                                  return (
                                    <span
                                      key={afe}
                                      className="relative inline-flex items-center h-[24px] select-none"
                                      data-testid={`inline-pill-afe-${wt.id}-${afe}`}
                                      title={tooltip}
                                    >
                                      <PillBg src={bluePill} />
                                      <span className="relative z-10 text-[11px] font-bold text-white px-2.5 whitespace-nowrap">
                                        {afe}
                                        {count > 1 ? (
                                          <span
            ...
            <div className="rounded border divide-y">
              ...
              {items.map((it) => (
                ...
                >
                  ...
                  {it.afe ? (
                    <span
                      className="relative inline-flex items-center h-[28px] select-none"
                      data-testid={`pill-afe-${it.assignmentId}`}
                    >
                      <PillBg src={bluePill} />
                      <span className="relative z-10 text-xs font-bold text-white px-3 whitespace-nowrap">
                        {it.afe}
                      </span>
                    </span>
                  ) : (
