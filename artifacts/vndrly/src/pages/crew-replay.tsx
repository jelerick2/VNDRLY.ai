...
import { LONG_DWELL_MS } from "@/lib/stops";

const LONG_DWELL_MINUTES = Math.round(LONG_DWELL_MS / 60000);
    ...
    <div className="space-y-4">
      ...
      <Card className="border-dashed" data-testid="card-replay-legend">
        <CardContent className="py-3 text-xs text-muted-foreground flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          <span className="inline-flex items-center gap-1.5" data-testid="legend-heading-stop">
            <span
              aria-hidden="true"
              style={{
                position: "relative",
            ...
            {t("crewReplay.legendStop", { minutes: LONG_DWELL_MINUTES })}
          </span>
        </CardContent>
      </Card>
    </div>
