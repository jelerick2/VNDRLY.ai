...
export function LiveConnectionPill({
  ...
  if (interactive) {
    return (
      <button
        ...
        className={cn(
          "group relative inline-flex items-center justify-center select-none h-[24px]",
          minWidthClass,
  ...
  return (
    <span
      ...
      data-status={status}
      className={cn(
        "group relative inline-flex items-center justify-center select-none align-middle pointer-events-none h-[24px]",
        compact ? "" : "min-w-[112px]",
      )}
    >
      <PillBg
