...
import catalogHealthRouter from "./catalogHealth";
import communicationsHealthRouter from "./communicationsHealth";
...
router.use(catalogHealthRouter);
router.use(communicationsHealthRouter);
