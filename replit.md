...
### Notifications & Email
Outbound emails, including password resets and invoice deliveries, are handled via SendGrid, with localized content. Vendor admins receive specific digests for accounting failures, reconciliation drifts, and other accounting issues.
